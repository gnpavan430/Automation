...
// Additional ranges to update ...
    ...
    public void appendValues(String network, Date timeStamp, Double loginTime, Double logoutTime) throws IOException {
        String range=null;
        Sheets service = getSheetsService();
        ...
        List<List<Object>> values = Arrays.asList(
                Arrays.asList(
                        // Cell values ...
                       timeString,loginTime,logoutTime
